...
## Główny backup – uruchom wszystko po kolei
...
## Co dokładnie masz po wykonaniu wszystkiego?

Plik/katalog,Rozmiar zwykle,Zawartość
"DCIM, Pictures, WhatsApp",kilkadziesiąt GB,"Zdjęcia, filmy, czaty WA"
apps_user.txt,kilka KB,Lista Twoich aplikacji
01_system_info.txt,~100 KB,"Model, Android, IMEI, IP, MAC itp."
bugreport.zip,5–30 MB,Pełny oficjalny raport błędów Androida
logcat_full.txt,1–20 MB,Wszystkie logi systemowe i aplikacji
drzewo_sdcard.txt,kilkaset KB,Pełna struktura plików na telefonie
